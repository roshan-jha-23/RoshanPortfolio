<script>
    ...
    export let tabs = [
        ...
        { name: "Blog", link: "https://medium.com/@Roshan-jha" },
         { name: "Contact", link: "mailto:roshan.cse120026@gmail.com" },
        // {name: '', link: ''},
    ];
</script>
...
>
    <h1 class="font-medium">
        <b class="font-bold open-sans">Roshan</b> <span class="">Jha</span>
    </h1>
    <div class="sm:flex items-center gap-4 hidden">
        ...
        <a href="https://www.linkedin.com/in/roshan-jha-20m10/" target="_blank">
